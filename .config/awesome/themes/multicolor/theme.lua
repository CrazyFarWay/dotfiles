...
theme.font                                      = "Hack 8"
theme.bg_normal                                 = "#261d3de6"
theme.bg_focus                                  = "#000000"
theme.bg_urgent                                 = "#000000"
theme.fg_normal                                 = "#FFFFFF"
theme.fg_focus                                  = "#FFFFFF"
theme.fg_urgent                                 = "#b53530"
theme.fg_minimize                               = "#FFFFFF"
theme.border_width                              = dpi(2)
theme.border_normal                             = "#00000000"
theme.border_focus                              = "#d1a6ff"
theme.border_marked                             = "#7842f5"
theme.menu_border_width                         = 0
theme.menu_width                                = dpi(400)
theme.menu_submenu_icon                         = theme.confdir .. "/icons/rightArrow.png"
theme.menu_fg_normal                            = "#FFFFFF"
theme.menu_fg_focus                             = "#000000"
theme.menu_bg_normal                            = "#805367"
theme.menu_bg_focus                             = "#fad6ff"
...
--        widget:set_markup(markup.fontfg(theme.font, "#04f4be", descr .. " @ " .. units .. "°C "))
--    end
--})
--
---- / fs
